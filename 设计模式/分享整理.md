...
if (orderType === 1) {
  if (orderWay === 1) {
    console.log('衣服订单 来源 淘宝')
  } else if (orderWay === 2) {
    console.log('衣服订单 来源 京东')
  } else if (orderWay === 3) {
    console.log('衣服订单 来源 拼多多')
  }
} else if (orderType === 2) {
  if (orderWay === 1) {
    console.log('手机订单 来源 淘宝')
  } else if (orderWay === 2) {
    console.log('手机订单 来源 京东')
  } else if (orderWay === 3) {
    console.log('手机订单 来源 拼多多')
  }
} else if (orderType === 3) {
  if (orderWay === 1) {
    console.log('家具订单 来源 淘宝')
  } else if (orderWay === 2) {
    console.log('家具订单 来源 京东')
  } else if (orderWay === 3) {
    console.log('家具订单 来源 拼多多')
  }
}
